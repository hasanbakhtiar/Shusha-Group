  ...
  return (
    ...
    <div className='col-12 col-sm-6 col-md-4'>
        ...
        <div className="card-body">
            ...
            <button onClick={()=>{
              navigation('/cart');
              notify(addItem(productdata))}} className="btn btn-warning"><span className='text-dark'>Add to card</span></button>
            <Link to={`/products/${id}`} className=" ms-3 btn btn-outline-dark">Read More</Link>
